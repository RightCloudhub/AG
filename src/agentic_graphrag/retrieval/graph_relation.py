...
_RELATION_CUES: dict[str, tuple[str, ...]] = {
    # Include Chinese surface forms so bilingual questions score the same edges.
    "CEO_OF": (
        "ceo",
        "chief executive",
        "leads",
    ...
    "WORKS_AT": ("work", "works", "worked", "employ", "job", "role", "title", "任职", "就职"),
    "WORKED_AT": (
        "previously work",
        "worked at",
        "former",
    ...
    # Ownership edges also answer "acquired / 收购" questions in this corpus.
    "PARENT_OF": (
        "parent",
        "owns",
        "own",
    ...
    "PRODUCES": ("produce", "product", "manufactur", "makes", "offers", "生产", "产品"),
    "COMPETES_WITH": ("compet", "rival", "versus", "vs", "竞争", "竞品"),
    "SUPPLIES": ("suppl", "vendor", "logistics", "供应", "物流"),
    "SUPPLIES_FOR": ("suppl", "component", "parts for", "供应"),
    "PARTICIPATED_IN": ("participat", "event", "partnership", "deal", "summit", "参与", "合作"),
    "ACQUIRED": ("acquir", "bought", "merger", "m&a", "收购"),
    "LOCATED_IN": (
        "located",
        "based in",
        "headquarter",
