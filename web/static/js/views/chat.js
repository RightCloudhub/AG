/* Chat view (P5-UI-02 U-05): the trial Q&A orchestration migrated verbatim
 * from the former single-root root.js / in-DOM template. Behavior frozen —
 * each turn is an independent question; no multi-turn context is ever sent
 * (V1 boundary). Element ids (q/askForm/forceAgentic/…) are asserted by tests.
 */
import { friendlyError, postFeedback, postQuery, streamQuery } from "../api.js";
