...
EXPANDED = [
    ("Northwind Analytics", "Boston", "business intelligence", 2012, "Apex Holdings", ["Helix Compute"], ["Northwind Insight Suite"]),
    ("Cedar Semiconductor", "Hsinchu", "semiconductors", 2003, None, ["SiliconForge"], ["CedarLink FPGA"]),
    ("Polaris Cloud", "Dublin", "cloud infrastructure", 2011, "Orion Systems", ["NovaTech Industries"], ["Polaris Stack"]),
    ("Summit Robotics", "Munich", "industrial robotics", 2009, None, [], ["SummitArm X3"]),
    ("Lumen Networks", "Stockholm", "networking", 2006, None, ["BrightLink Logistics"], ["LumenMesh Switch"]),
    ("Atlas Mobility", "Berlin", "logistics software", 2014, "BrightLink Logistics", [], ["Atlas Route OS"]),
    ...
    ("Nimbus Security", "Tel Aviv", "cybersecurity", 2010, None, ["Orion Systems"], ["Nimbus Shield"]),
    ("Cobalt Materials", "Pittsburgh", "advanced materials", 2004, None, ["Harbor Components"], ["Cobalt Thermal Sheet"]),
    ...
    ("Delta Fabrication", "Detroit", "manufacturing", 1997, "Apex Holdings", [], ["Delta Press Line"]),
    ("Echo Media Labs", "Los Angeles", "media tech", 2017, None, [], ["Echo Stream Engine"]),
    ("Frost Data", "Toronto", "data platforms", 2014, "Orion Systems", ["Northwind Analytics"], ["Frost Lakehouse"]),
    ("Granite Storage", "Phoenix", "storage systems", 2009, None, ["Helix Compute", "NovaTech Industries"], ["Granite Array"]),
    ("Horizon Optics", "Kyoto", "optical components", 2002, None, ["SiliconForge"], ["Horizon Lens Array"]),
    ("Ivory Payments", "Singapore", "payments", 2015, "Meridian Capital", ["Keystone Finance"], ["Ivory PayRail"]),
    ("Jade Mobility", "Seoul", "EV components", 2011, None, ["Harbor Components"], ["Jade Battery Module"]),
    ("Kinetic Sensors", "Zurich", "IoT sensors", 2013, "Summit Robotics", [], ["Kinetic Node"]),
    ("Lattice AI", "Montreal", "ML infrastructure", 2018, "Polaris Cloud", ["Nimbus Security"], ["Lattice Train Hub"]),
    ("Mosaic Retail", "Paris", "retail analytics", 2016, "Northwind Analytics", [], ["Mosaic Shelf AI"]),
    ("Nexus Harbor", "Rotterdam", "port logistics", 2000, "BrightLink Logistics", ["Atlas Mobility"], ["Nexus Berth OS"]),
    ...
    ("Riverbank Credit", "Frankfurt", "credit analytics", 2011, "Meridian Capital", ["Keystone Finance"], ["Riverbank Score"]),
    ("Solstice Solar", "Phoenix", "solar hardware", 2010, "Redwood Energy", [], ["Solstice Panel Pro"]),
    ("Titan Forge", "Birmingham", "industrial metals", 1988, "Apex Holdings", ["Cobalt Materials"], ["Titan Alloy Plate"]),
    ("Umbra Imaging", "Helsinki", "medical imaging", 2005, None, ["Cascade Bio"], ["Umbra MRI Core"]),
    ("Vertex Chips", "Bangalore", "chip design", 2006, None, ["SiliconForge", "Cedar Semiconductor"], ["Vertex Edge ASIC"]),
    ("Willow Telecom", "Tokyo", "telecom gear", 1996, "Lumen Networks", [], ["Willow 5G Base"]),
    ("Xenon Chemicals", "Houston", "specialty chemicals", 1991, None, ["Cobalt Materials"], ["Xenon Polymer X"]),
    ("Yellowstone Data", "Denver", "geospatial data", 2015, "Frost Data", ["Northwind Analytics"], ["Yellowstone Map API"]),
    ("Zenith Aerospace", "Toulouse", "aerospace components", 2003, None, ["Onyx Defense"], ["Zenith Actuator"]),
    ("Amber Logic", "Amsterdam", "EDA tools", 2008, "Vertex Chips", ["SiliconForge"], ["Amber PlaceRoute"]),
    ("BluePeak Cloud", "Sydney", "regional cloud", 2016, "Polaris Cloud", ["Orion Systems"], ["BluePeak Region"]),
    ("Coral Reef Bio", "San Diego", "marine biotech", 2014, "Cascade Bio", [], ["Coral Reef Assay"]),
    ("Drift Commerce", "Hangzhou", "e-commerce platform", 2013, None, ["Mosaic Retail"], ["Drift Storefront"]),
    ("Ember Foundry", "Dresden", "chip foundry", 2000, None, ["SiliconForge", "Cedar Semiconductor"], ["Ember 7nm Node"]),
    ("Falcon Logistics", "Dubai", "regional logistics", 2009, "BrightLink Logistics", ["Nexus Harbor"], ["Falcon Lane"]),
    ("Glacier Analytics", "Reykjavik", "climate data", 2017, "Yellowstone Data", [], ["Glacier Climate Graph"]),
    ("Harbor Wind", "Copenhagen", "offshore wind", 2012, "Redwood Energy", ["Solstice Solar"], ["Harbor Turbine Ctrl"]),
    ("Indigo Pharma IT", "Basel", "pharma IT", 2010, "Pulse Health", [], ["Indigo Trial OS"]),
    ("Jasper Boards", "Portland", "hardware boards", 2011, "Helix Compute", ["Harbor Components"], ["Jasper Carrier Board"]),
    ("Kite Drones", "Austin", "commercial drones", 2015, "Summit Robotics", ["Zenith Aerospace"], ["Kite Surveyor"]),
    ("Lotus FinOps", "Singapore", "finops software", 2019, "Keystone Finance", ["Ivory Payments"], ["Lotus Cost Map"]),
    ("Marble Vault", "Geneva", "custody tech", 2018, "Meridian Capital", ["Riverbank Credit"], ["Marble Custody API"]),
    ("Nova Edge Labs", "Austin", "edge computing R&D", 2020, "NovaTech Industries", ["Helix Compute"], ["Nova Edge Kit"]),
    ("Orbit Satcom", "Cape Canaveral", "satellite comms", 2004, "Zenith Aerospace", ["Willow Telecom"], ["Orbit Link Modem"]),
    ("Pine Grove Soft", "Raleigh", "developer tools", 2014, "Orion Systems", ["Lattice AI"], ["Pine Grove IDE"]),
    ("Quill Publishing AI", "New York", "content AI", 2018, "Echo Media Labs", [], ["Quill Draft Engine"]),
    ("Ridge Battery", "Nagoya", "battery cells", 2007, "Jade Mobility", ["Harbor Components"], ["Ridge Cell 2170"]),
    ("Sable Insurance AI", "Hartford", "insurtech", 2016, "Riverbank Credit", [], ["Sable Risk Graph"]),
    ("Terra Farm Tech", "Des Moines", "agritech", 2013, None, ["Kinetic Sensors"], ["Terra Yield OS"]),
    ("Ultraviolet Clean", "Osaka", "UV disinfection", 2011, None, ["Pulse Health"], ["UV Clean Chamber"]),
    ("Violet Optics", "Grenoble", "photonics", 2009, "Horizon Optics", ["SiliconForge"], ["Violet PIC Chip"]),
    ("Wren Audio AI", "Nashville", "audio ML", 2017, "Echo Media Labs", [], ["Wren Transcribe"]),
    ("Yarrow Materials", "Leeds", "composites", 2005, "Titan Forge", ["Cobalt Materials"], ["Yarrow Carbon Weave"]),
    ("Zephyr Ventures", "Palo Alto", "venture studio", 2012, "Meridian Capital", [], ["Zephyr Studio OS"]),
]
...
PEOPLE = [
    ...
    ("Mia Torres", "CEO", "Echo Media Labs", ["Quill Publishing AI", "Wren Audio AI"], "Los Angeles"),
...
PRODUCTS_EXTRA = [
    ("QuantumEdge Server", "NovaTech Industries", ["SiliconForge", "Harbor Components"], "enterprise server"),
...
EVENTS = [
    ("Harbor Partnership 2024", "2024-03", "strategic partnership", ["NovaTech Industries", "Harbor Components", "Apex Holdings"], "minority partnership strengthening QuantumEdge Server supply chain"),
    ("SiliconForge Capacity Expansion 2023", "2023-06", "capex", ["SiliconForge", "Ember Foundry"], "joint capacity expansion for advanced chips"),
    ("Meridian Apex Growth Fund Close", "2022-11", "funding", ["Meridian Capital", "Apex Holdings", "Zephyr Ventures"], "growth fund close supporting Southeast Asia tech"),
    ("Helix-Granite Storage Alliance", "2023-09", "alliance", ["Helix Compute", "Granite Storage"], "co-selling enterprise storage + server stacks"),
    ("BrightLink Falcon Integration", "2024-01", "integration", ["BrightLink Logistics", "Falcon Logistics", "Nexus Harbor"], "regional logistics network integration"),
    ("Polaris BluePeak Merger Talks", "2024-05", "M&A talks", ["Polaris Cloud", "BluePeak Cloud", "Orion Systems"], "regional cloud consolidation discussions"),
    ("Vertex Ember Tapeout Event", "2023-12", "product launch", ["Vertex Chips", "Ember Foundry", "Amber Logic"], "first Vertex Edge ASIC tapeout on Ember 7nm"),
    ("Redwood Solstice Grid Deal", "2022-08", "commercial deal", ["Redwood Energy", "Solstice Solar", "Harbor Wind"], "grid-scale storage and solar package"),
    ("Cascade Umbra Imaging JV", "2021-04", "joint venture", ["Cascade Bio", "Umbra Imaging"], "joint medical instrument R&D"),
    ("NovaTech Edge Labs Spin-in", "2020-10", "reorg", ["NovaTech Industries", "Nova Edge Labs", "Apex Holdings"], "edge computing lab spun into Nova Edge Labs"),
    ("Lumen Willow 5G Pact", "2023-02", "partnership", ["Lumen Networks", "Willow Telecom"], "5G equipment interoperability pact"),
    ("Keystone Ivory Payments Rail", "2024-02", "product launch", ["Keystone Finance", "Ivory Payments", "Lotus FinOps"], "cross-border pay rail launch"),
    ("Summit Kite Drone Acquisition", "2022-05", "acquisition", ["Summit Robotics", "Kite Drones"], "Summit acquired Kite Drones survey unit"),
    ("Onyx Zenith Defense Contract", "2021-09", "contract", ["Onyx Defense", "Zenith Aerospace", "Orbit Satcom"], "joint defense components contract"),
    ("Frost Yellowstone Data Merge", "2023-07", "M&A", ["Frost Data", "Yellowstone Data", "Orion Systems"], "geospatial data assets merged under Frost"),
    ("Northwind Mosaic Retail Carveout", "2022-12", "carveout", ["Northwind Analytics", "Mosaic Retail"], "retail analytics line carved into Mosaic"),
    ("Titan Yarrow Materials Supply Pact", "2024-04", "supply pact", ["Titan Forge", "Yarrow Materials", "Apex Holdings"], "long-term carbon composite supply"),
    ("Pulse Indigo Pharma IT Bundle", "2023-03", "bundle", ["Pulse Health", "Indigo Pharma IT"], "clinical trial + care cloud bundle"),
    ("Drift Mosaic Commerce Link", "2024-06", "partnership", ["Drift Commerce", "Mosaic Retail"], "storefront + shelf AI commerce link"),
    ("Riverbank Sable Risk Graph Launch", "2023-11", "product launch", ["Riverbank Credit", "Sable Insurance AI", "Meridian Capital"], "shared risk graph for credit and insurance"),
]
...
def _person_bio(
    ...
    if prior:
        if len(prior) == 1:
            lines.append(
                f"Before {company}, {name} worked at {prior[0]}."
            )
        else:
            joined = ", ".join(prior[:-1]) + f", and {prior[-1]}"
            lines.append(
                f"Before {company}, {name} worked at {joined}."
            )
        lines.append("")
    lines.append(
...
def _event_doc(
    ...
    if len(participants) >= 2:
        lines.append(
            f"Primary participants included {', '.join(participants[:-1])}, "
            f"and {participants[-1]}."
        )
    return "\n".join(lines)
...
def _sector_overview(idx: int) -> str:
    sectors = [
        ...
        (
            "Capital & Fintech",
            ["Meridian Capital", "Keystone Finance", "Ivory Payments", "Riverbank Credit", "Zephyr Ventures"],
            "funds, ledgers, payments, and credit scores",
        ),
        (
            "Industrial Automation",
            ["Summit Robotics", "Kinetic Sensors", "Kite Drones", "Delta Fabrication", "Titan Forge"],
        ...
        (
            ...
            ["Apex Holdings", "NovaTech Industries", "BrightLink Logistics", "Delta Fabrication", "Titan Forge"],
    ...
    if len(cos) >= 2:
        ...
        lines.append("")
    lines.append(
        f"Cross-document multi-hop questions in this sector typically traverse "
        f"parent companies, CEOs, prior employers, products, and shared suppliers."
    )
    return "\n".join(lines)
...
def generate(out: Path, min_count: int) -> int:
    ...
    for name, city, industry, founded in CORE_COMPANIES:
        ...
        if name == "Helix Compute":
            body += (
                "\n\nHelix Compute competes with NovaTech Industries and produces HelixCore Server. "
                "SiliconForge supplies processors for HelixCore Server."
            )
