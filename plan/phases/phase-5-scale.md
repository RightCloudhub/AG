...
- [x] `P5-UI-02` 前端重规划：问答 → 角色感知控制台（知识运维 / 审核 / 可观测 / 图谱浏览视图；M0 API 前置 `GET /v1/me` + `GET /v1/ingest-tasks` 列表；零构建边界不变，无需新 ADR）— **2026-09-07 交付**（M2b 视觉体系 U-14/U-15 随同日 P5-UI-03 结构重设计关闭）— 执行计划：[p5-ui-02-console-replan.md](./p5-ui-02-console-replan.md)
